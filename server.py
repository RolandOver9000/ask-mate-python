...
def route_list():
    """
    Sorts questions and renders template for the page that lists them.
    Sorting parameters are retrieved from the query string generated by pressing the 'Sort' button.
    ...
    sorted_questions = data_manager.get_sorted_questions(order_by, order_direction)
